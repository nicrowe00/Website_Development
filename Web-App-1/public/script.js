...
function welcomeUser() {
  ...
  document.getElementById('welcomeuser').innerHTML = '<p> Hello, ' + username + ', looking forward to hearing what your favourite films are! Click this message to close it.</p>';
